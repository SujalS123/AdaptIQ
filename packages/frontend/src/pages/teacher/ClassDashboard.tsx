    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <Card style={{ padding: '24px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ padding: '16px', backgroundColor: 'var(--bg-secondary)', borderRadius: '8px', borderLeft: '3px solid var(--color-primary)' }}>
            <strong>Priya Sharma</strong> just completed the "BCNF Normalization" interactive quiz with a score of 95%.
          </div>
          <div style={{ padding: '16px', backgroundColor: 'var(--bg-secondary)', borderRadius: '8px', borderLeft: '3px solid var(--color-success)' }}>
            <strong>Rahul Kumar</strong> earned the "Database Architect" badge.
          </div>
          <div style={{ padding: '16px', backgroundColor: 'var(--bg-secondary)', borderRadius: '8px', borderLeft: '3px solid var(--color-danger)' }}>
