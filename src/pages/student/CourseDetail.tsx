    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '24px', flex: 1 }}>
          ...
          <Card style={{ display: 'flex', flexDirection: 'column', height: '620px', padding: '0px', overflow: 'hidden' }}>
            <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', gap: '10px', background: 'var(--bg-secondary)', color: 'white' }}>
            ...
            <div style={{ flex: 1, padding: '20px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {isNovaTyping && (
                <div style={{ display: 'flex', gap: '6px', alignSelf: 'flex-start', padding: '12px 16px', background: 'var(--bg-secondary)', color: 'white', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
            ...
            {/* Chat Input panel */}
            <div style={{ padding: '16px 20px', borderTop: '1px solid var(--border-color)', background: 'var(--bg-secondary)', color: 'white', display: 'flex', gap: '10px' }}>
              <input 
                type="text"
