            ...
            <Card style={{ display: 'flex', gap: '20px', alignItems: 'center', borderLeft: '4px solid var(--color-primary)' }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ fontSize: '10px', padding: '2px 6px', borderRadius: '4px', backgroundColor: 'var(--bg-secondary)', color: 'white', border: '1px solid var(--border-color)', color: 'var(--text-secondary)' }}>
                    RAG Synced
                  </span>
                </div>
