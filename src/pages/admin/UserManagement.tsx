    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <Card style={{ padding: '0px', overflow: 'hidden' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
          <thead style={{ backgroundColor: 'var(--bg-secondary)', color: 'white', borderBottom: '1px solid var(--border-color)' }}>
            <tr>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid var(--border-color)' }}>
              ...
              <td style={{ padding: '16px', color: 'var(--text-secondary)' }}>priya@eduai.edu</td>
            ...
            <tr style={{ borderBottom: '1px solid var(--border-color)' }}>
              ...
              <td style={{ padding: '16px', color: 'var(--text-secondary)' }}>sharma@eduai.edu</td>
            ...
            <tr>
              ...
              <td style={{ padding: '16px', color: 'var(--text-secondary)' }}>admin@eduai.edu</td>
