    ...
    <Card style={{ padding: '32px' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', justifyContent: 'center', marginBottom: '24px' }}>
        <Button type="button" variant="secondary" onClick={() => {
          login('mock_student_token', { id: '1', email: 'priya@eduai.edu', name: 'Priya', role: 'student' });
          navigate('/');
        }} style={{ padding: '6px 12px', fontSize: '12px' }}>Student Demo</Button>
        <Button type="button" variant="secondary" onClick={() => {
          login('mock_teacher_token', { id: '2', email: 'sharma@eduai.edu', name: 'Mr. Sharma', role: 'teacher' });
          navigate('/teacher');
        }} style={{ padding: '6px 12px', fontSize: '12px' }}>Teacher Demo</Button>
        <Button type="button" variant="secondary" onClick={() => {
          login('mock_admin_token', { id: '3', email: 'admin@eduai.edu', name: 'Admin', role: 'admin' });
          navigate('/admin');
        }} style={{ padding: '6px 12px', fontSize: '12px' }}>Admin Demo</Button>
      </div>
